...
Vector2D Agent::getTargetVelocity()
{
...
Vector2D Agent::getSteeringForce()
{
	return steeringForce;
}
float Agent::getArriveSpeed()
{
	return ArriveSpeed;
}
...
void Agent::setTargetVelocity(Vector2D _targetVelocity)
{
	targetVelocity = _targetVelocity;
}
void Agent::setAcceleration(Vector2D _acceleration)
{
...
void Agent::setSteeringForce(Vector2D _steeringForce)
{
	steeringForce = _steeringForce;
}
void Agent::setArriveSpeed(float _ArriveSpeed)
{
	ArriveSpeed = _ArriveSpeed;
}
